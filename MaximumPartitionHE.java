 ...
 * Problem:https://www.hackerearth.com/problem/algorithm/measuring-weights-54c2dc75-b4ccf064/?purpose=login&source=problem-page&update=google
 * Name:Maximum Partition
 */
import java.util.*;
import java.io.*;
public class MaximumPartitionHE{
    ...
    public static void main(String args[]) throws IOException {
        ...
        while(t-->0){
            ...
            if (n == 1) {
                ...
                System.out.println(Math.max(Math.abs(arr[0] - arr[1]), Math.abs(arr[0] + arr[1])));
