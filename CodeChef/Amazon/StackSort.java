 ...
 * Problem:https://www.codechef.com/practice/course/amazon-interview-questions/AMAZONPREP/problems/STKSORT?tab=statement
 * Name:Stack Sort
 */
import java.util.*;
import java.io.*;
class StackSort{
    ...
    //Here's what u want :)
    static String canSortUsingStack(int[] A) {
    ...
    public static void main(String args[]) throws IOException {
        ...
        while(t-- > 0) {
            ...
            out.println(canSortUsingStack(arr));
            out.flush();
        }
